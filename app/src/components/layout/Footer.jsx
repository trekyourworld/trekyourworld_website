...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white pt-12 pb-8 w-full">
      <div className="w-full px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Trekyourworld</h3>
            <p className="text-gray-400 mb-4">
              TrekYourWorld is not a trekking company, but your trusted source for unbiased trek information, community price comparisons, and direct guide contacts—helping you plan your next adventure smarter.
            </p>
            <div className="flex justify-center space-x-4">
              ...
              <a href={INSTA_LINK} className="text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Get the latest trek updates, community deals, and expert tips—straight to your inbox.</p>
            <form className="flex">
              <div className="relative flex-grow">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2 bg-gray-700 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              <button 
                type="submit"
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Trekyourworld. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
