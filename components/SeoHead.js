...
const defaultMeta = {
  title: 'Trekyourworld',
  siteName: 'Trekyourworld',
  description:
    'Landing page for Trekyourworld app to enhance your trekking experience.',
  // change base url of your web (without '/' at the end)
  url: 'https://trekyourworld.com',
  type: 'website',
  robots: 'follow, index',
  // change with url of your image (recommended dimension = 1.91:1)
  // used in twitter, facebook, etc. card when link copied in tweet/status 
  image: 'https://trekyourworld.com/assets/card-image.png',
  author: 'Aditya Kumar'
};
